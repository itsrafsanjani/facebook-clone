<template>
    <div class="bg-white h-12 w-full px-4 flex flex items-center border-b border-gray-200 shadow-sm">
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
                ...
                <div class="ml-2 relative">
                    ...
                    <input type="text" name="search" id="" class="rounded-full w-56 pl-8 bg-gray-200 h-8 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-transparent text-sm" placeholder="Search Facebook">
                </div>
            </div>
        </div>
